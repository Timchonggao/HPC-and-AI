...
#    (save_dir / 'labels' if save_txt else save_dir).mkdir(parents=True, exist_ok=True)  # make dir
    ...
    model = Model('/workspace/volume/private/09_Yolov5x_0.06/yolov5_ck_test/models/yolov5x.yaml')
    state_dict = torch.load('/workspace/volume/private/09_Yolov5x_0.06/yolov5_ck_test/yolov5x_int8.pth')
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        print(box_result)
        print("pred.shape", box_result[0].shape)
...
#            draw = cv2.rectangle(im0s, (int(pt[0]), int(pt[1])), (int(pt[2]), int(pt[3])), (255,0,0), 2)
#        cv2.imwrite("./mlu_out_bus.jpg", draw)
#
#        print("Test mlu successfully!")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='/workspace/volume/private/09_Yolov5x_0.06/yolov5_ck_test/data/images', help='source')  # file/folder, 0 for webcam
