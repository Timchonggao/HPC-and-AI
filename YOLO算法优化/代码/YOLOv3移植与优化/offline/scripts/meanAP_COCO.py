...
class_dict = { 'person':1,'bicycle':2,'car':3,
               ...
               'traffic_light':10,'fire_hydrant':11, 'street_sign':12, 'stop_sign':13,
               'parking_meter':14,'bench':15,'bird':16,
               'cat':17,'dog':18,'horse':19,
               'sheep':20,'cow':21,'elephant':22,
               'bear':23,'zebra':24,'giraffe':25, 'hat':26,
               'backpack':27,'umbrella':28, 'shoe':29, 'eye_glasses':30, 'handbag':31,
               ...
               'bottle':44, 'plate':45, 'wine_glass':46,'cup':47,
               ...
               'sofa':63,'pottedplant':64,'bed':65, 'mirror':66,
               'diningtable':67, 'window':68, 'desk':69, 'toilet':70,'door':71,'tvmonitor':72,
               'laptop':73,'mouse':74,'remote':75,
               'keyboard':76,'cell_phone':77,'microwave':78,
               'oven':79,'toaster':80,'sink':81,
               'refrigerator':82,'blender':83,'book':84,'clock':85,
...
def get_args():
    ...
    parser.add_argument("--net_name", dest = "net_name", help =
                        'the name of net',
                        default = '', type = str)
...
if __name__ == "__main__":
    ...
    generate_mAP_json(args.net_name, coco_eval)
