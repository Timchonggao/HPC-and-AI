...
print_info(){
    ...
    echo "|     accuracy test code position: "
    ...
    echo "|     accuracy test code position: "
    echo "|         $CURRENT_DIR/offline/yolov3/run_offline_accuracy.sh "
    echo "|         $CURRENT_DIR/offline/scripts/meanAP_COCO.py."
    echo "|"
}
...
do_run 2>&1 |tee 00_Yolov3_example_accuracy_result
